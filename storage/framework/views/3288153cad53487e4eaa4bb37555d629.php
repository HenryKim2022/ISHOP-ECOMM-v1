            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section-title text-center">
                        <h2 class="mb-3"><?php echo e(localize('Browse Recent Post')); ?></h2>
                        <p class="mb-0"><?php echo e(localize('Learn More About Our Recent Exclusive News, Updates & Articles')); ?>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <article class="blog-card rounded-2 overflow-hidden bg-white">
                            ...
                            <div class="blog-card-content">
                                ...
                                <a href="<?php echo e(route('home.blogs.show', $blog->slug)); ?>"
                                    class="btn btn-primary-light btn-md"><?php echo e(localize('Explore More')); ?><span
...
<?php endif; ?><?php /**PATH G:\laragon\www\resources\views/frontend/default/pages/partials/home/blogs.blade.php ENDPATH**/ ?>