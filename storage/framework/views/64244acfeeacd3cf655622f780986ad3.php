<li>
    <a href="<?php echo e(route('support.ticket.create')); ?>" class="<?php echo e(areActiveRoutes(['support.ticket.create'], 'active')); ?>">
        <span class="me-2">
        ...
        <?php echo e(localize('Create Ticket')); ?>

    </a>
</li>
<li>
    <a href="<?php echo e(route('support.ticket.index')); ?>" class="<?php echo e(areActiveRoutes(['support.ticket.index'], 'active')); ?>">
        <span class="me-2">
        ...
        <?php echo e(localize('All Tickets')); ?>

    </a>
</li>
<?php /**PATH G:\laragon\www\Modules/Support\Resources/views/sidebar/customer_sidebar.blade.php ENDPATH**/ ?>