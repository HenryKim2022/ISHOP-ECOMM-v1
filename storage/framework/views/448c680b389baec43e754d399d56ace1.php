<header class="gheader position-relative z-2 header-sticky">
    ...
    ?>
    <div class="ghead-topbar <?php echo e($bgClass); ?> d-none d-lg-block">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xxl-4 col-xl-3">
                    <div class="topbar-info d-none d-xl-block">
                        <p class="text-white fs-sm fw-medium mb-0"><?php echo e(getSetting('topbar_welcome_text')); ?></p>
                    </div>
                ...
                <div class="col-xxl-8 col-xl-9">
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <?php if(getSetting('topbar_email')): ?>
                                <a href="mailto:<?php echo e(getSetting('topbar_email')); ?>" class="text-light">
                                    <span class="me-1">
                        ...
                        <li class="nav-item dropdown tt-language-dropdown">
                            <?php if(\App\Models\Location::count() > 1 || getSetting('topbar_location')): ?>
                                <span class="me-1">
                            ...
                            <?php endif; ?>
                            <?php if(\App\Models\Location::count() > 1): ?>
                                <?php
                                ...
                                <a href="#" class="dropdown-toggle text-capitalize text-light"
                                    ...
                                    aria-expanded="false"><?php echo e($location->name); ?></a>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Location::where('is_published', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a class="dropdown-item fs-xs text-capitalize"
                                               ...
                                               data-location="<?php echo e($location->id); ?>">
                        ...
                        <li class="nav-item dropdown tt-curency-dropdown">
                            <a href="#" class="dropdown-toggle text-uppercase text-light"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"><?php echo e($currentCurrency->symbol); ?>

                                <?php echo e($currentCurrency->code); ?></a>
                            <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li class="nav-item">
                            <a href="javascript:void(0)" class="btn btn-link p-0 tt-theme-toggle fw-normal text-light">
                                <div class="tt-theme-light" data-bs-toggle="tooltip" data-bs-placement="left"
                                    data-bs-title="Dark"><?php echo e(localize('Dark')); ?> <i class="fas fa-moon fs-lg ms-1"></i>
                                </div>
                                <div class="tt-theme-dark" data-bs-toggle="tooltip" data-bs-placement="left"
                                    data-bs-title="Light"><?php echo e(localize('Light')); ?> <i class="fas fa-sun fs-lg ms-1"></i>
                                </div>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-3 col-md-3 col-5">
                    ...
                    <a href="<?php echo e(route('home')); ?>"
                        ...
                        <img src="<?php echo e(uploadedAsset(getSetting('navbar_logo'))); ?>" class="tt-brand-favicon ms-1" alt="sitelogo" />
                        <?php if(getSetting('admin_panel_logo') != ''): ?>
                            <img src="<?php echo e(uploadedAsset(getSetting('admin_panel_logo'))); ?>" class="tt-brand-logo ms-2" alt="sitelogo" />
                        <?php else: ?>
                            <h2 class="d-inline-block text-dark-light px-2 mr-auto mt-auto mb-auto"><?php echo e(env('APP_NAME')); ?></h2>
                        <?php endif; ?>
                    </a>
                ...
                <div class="col-xxl-10 col-xl-9 col-md-9 col-7">
                    <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                        ...
                        <?php if(getSetting('show_navbar_categories') != 0 || getSetting('show_navbar_categories') == null): ?>
                            <div class="category-dropdown position-relative d-none d-md-inline-block">
                                <a href="javascript:void(0)"
                                    class="category-dropdown-btn fw-bold d-none d-sm-inline-block"><?php echo e(localize('Categories')); ?><span
                                ...
                                <div class="category-dropdown-box scrollbar">
                                    <ul class="category-dropdown-menu">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navbarCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <a href="<?php echo e(route('products.index')); ?>?&category_id=<?php echo e($navbarCat->id); ?>"
                                                    class="d-flex align-items-center">
                                                    <div class="me-2 avatar-icon">
                                                        <img src="<?php echo e(uploadedAsset($navbarCat->collectLocalization('thumbnail_image'))); ?>"
                                                            alt="" class="rounded-circle h-100 w-100">
                                                    </div>
                                                    <span><?php echo e($navbarCat->collectLocalization('name')); ?></span>
                                                </a>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                            <ul class="d-flex align-itmes-center justify-content-end">
                                ...
                                ?>
                                <?php if(getSetting('show_theme_changes') != 0 || getSetting('show_theme_changes') == null && $theme_count > 1): ?>
                                        ...
                                        ?>
                                        <?php if(!empty($activeThemes)): ?>
                                            <li class="has-submenu">
                                                <a href="javascript:void(0);"><?php echo e(localize('Home')); ?><span
                                ...
                                <?php if(!is_null(getSetting('header_menu_labels'))): ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                <?php if(getSetting('show_theme_changes') == 0 || !getSetting('show_theme_changes')): ?>
                                ...
                                <?php if(getSetting('show_navbar_pages') != 0 || getSetting('show_navbar_pages') == null): ?>
                                    <li class="has-submenu">
                                        <a href="javascript:void(0);"><?php echo e(localize('Pages')); ?><span
                                                class="ms-1 fs-xs float-end"><i
                                                    class="fa-solid fa-angle-down"></i></span></a>
                                        <ul>
                                            <?php
                                            ...
                                            <li><a
                                                    href="<?php echo e(route('home.pages.aboutUs')); ?>"><?php echo e(localize('About Us')); ?></a>
                                            </li>
                                            <li><a
                                                    href="<?php echo e(route('home.pages.contactUs')); ?>"><?php echo e(localize('Contact Us')); ?></a>
                                            </li>
                                            ...
                                            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navbarPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <a href="<?php echo e(route('home.pages.show', $navbarPage->slug)); ?>"
                                                        class="d-flex align-items-center">
                                                        <span><?php echo e($navbarPage->collectLocalization('title')); ?></span>
                                                    </a>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                        ...
                        <div
                            ...
                            <div class="gshop-header-search dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end border-0">
                                    <form class="search-form d-flex align-items-center"
                                        ...
                                        <input type="text" placeholder="<?php echo e(localize('Search products')); ?>"
                                    ...
                                    <ul class="user-menu">
                                        <?php if(auth()->guard()->check()): ?>
                                            ...
                                            <li><a href="<?php echo e(route('logout')); ?>"><span class="me-2"><i
                                                            class="fa-solid fa-arrow-right-from-bracket"></i></span><?php echo e(localize('Sign Out')); ?>
                            ...
                            <div class="gshop-header-cart position-relative">
                                ...
                                <button type="button" class="header-icon">
                                    ...
                                    <span
                                        class="cart-counter badge bg-primary rounded-circle p-0 <?php echo e(count($carts) > 0 ? '' : 'd-none'); ?>"><?php echo e(count($carts)); ?></span>
                                </button>
                        ...
                        <div
                            ...
                            <a href="tel:<?php echo e(getSetting('navbar_contact_number')); ?>"
                                class="d-flex align-items-center">
                                <span
                                ...
                                <div class="ms-3">
                                    <span class="text-muted fs-xs"><?php echo e(localize('Phone & Telephone')); ?></span>
                                    <h6 class="mb-0 mt-1 fs-sm"><?php echo e(getSetting('navbar_contact_number')); ?></h6>
                                </div>
                            </a>
                        </div>
...
<?php /**PATH G:\laragon\www\resources\views/frontend/default/inc/header.blade.php ENDPATH**/ ?>