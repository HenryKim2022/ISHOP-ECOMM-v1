            ...
            <form action="" class="direct-add-to-cart-form">
                ...
                <?php if(!$isVariantProduct && $stock < 1): ?>
                    <a href="javascript:void(0);" class="btn btn-secondary d-block btn-md rounded-1 w-100">
                        <?php echo e(localize('Out of Stock')); ?></a>
                <?php else: ?>
                    <a href="javascript:void(0);" onclick="directAddToCartFormSubmit(this)"
                        class="btn btn-secondary d-block btn-md rounded-1 w-100 direct-add-to-cart-btn add-to-cart-text"><?php echo e(localize('Add to Cart')); ?></a>
                <?php endif; ?>
            </form>
        <?php endif; ?>
    </div>
</div>
<?php /**PATH G:\laragon\www\resources\views/frontend/default/pages/partials/products/trending-product-card.blade.php ENDPATH**/ ?>