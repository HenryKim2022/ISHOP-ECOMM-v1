    ...
    <div class="d-table table-layout-fixed w-100">
        <a class="d-table-cell mobile-toolbar-item  mobile-menu-toggle">
            <span class="mobile-toolbar-icon"><i class="fas fa-bars"></i></span><span
                class="mobile-toolbar-label"><?php echo e(localize('Category')); ?>
...
<div class="offcanvas-left-menu position-fixed">
    <div class="mobile-menu">
        ...
        <a href="<?php echo e(route('home')); ?>" class="d-inline-block mb-5"><img
...
<?php /**PATH G:\laragon\www\resources\views/frontend/default/inc/bottomToolbar.blade.php ENDPATH**/ ?>