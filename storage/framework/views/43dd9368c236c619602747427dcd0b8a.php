        ...
        <div class="container">
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0"><?php echo e(localize('Features Section')); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="about_features_title" class="form-label"><?php echo e(localize('Title')); ?></label>
                                    ...
                                    <input type="text" name="about_features_title" id="about_features_title"
                                        ...
                                        value="<?php echo e(getSetting('about_features_title')); ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="about_features_sub_title" id="about_features_sub_title"
                                        ...
                                        value="<?php echo e(getSetting('about_features_sub_title')); ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table tt-footable" data-use-parent-width="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="xs sm"><?php echo e(localize('Text')); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="avatar avatar-md">
                                                    <img class="rounded" src="<?php echo e(uploadedAsset($feature->image)); ?>"
                                                        alt="" />
                                                </div>
                                            </td>
                                                ...
                                                <div class="dropdown tt-tb-dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end shadow">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(route('admin.appearance.about-us.editFeatures', ['id' => $feature->id, 'lang_key' => env('DEFAULT_LANGUAGE')])); ?>&localize">
                                                        ...
                                                        <a href="#" class="dropdown-item confirm-delete"
                                                            data-href="<?php echo e(route('admin.appearance.about-us.deleteFeatures', $feature->id)); ?>"
                    ...
                    <!-- add features -->
                    <form action="<?php echo e(route('admin.appearance.about-us.storeFeatures')); ?>" method="POST"
                        enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <!--slider info start-->
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="mb-4"><?php echo e(localize('Add New Feature')); ?></h5>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="text" id="text"
                                        placeholder="<?php echo e(localize('Type text')); ?>" class="form-control" required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-4">
                                    <button class="btn btn-primary" type="submit">
                                        <i data-feather="save" class="me-1"></i> <?php echo e(localize('Save Feature')); ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\resources\views/backend/pages/appearance/aboutUs/features.blade.php ENDPATH**/ ?>