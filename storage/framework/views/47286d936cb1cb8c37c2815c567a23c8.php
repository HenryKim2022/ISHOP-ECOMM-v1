...
<body>
    ...
    <div id="preloader" class="bg-light-subtle">
        <div class="preloader-wrap">
            <img src="<?php echo e(uploadedAsset(getSetting('navbar_logo'))); ?>" class="img-fluid" max-width="180">
...
<?php /**PATH G:\laragon\www\resources\views/backend/layouts/master.blade.php ENDPATH**/ ?>