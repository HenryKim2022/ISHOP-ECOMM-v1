...
<?php $__env->startSection('breadcrumb-contents'); ?>
    <div class="breadcrumb-content">
        <h2 class="mb-2 text-center"><?php echo e(localize('Products')); ?></h2>
        <nav>
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item fw-bold" aria-current="page"><a
                        href="<?php echo e(route('home')); ?>"><?php echo e(localize('Home')); ?></a></li>
                <li class="breadcrumb-item fw-bold" aria-current="page"><?php echo e(localize('Products')); ?></li>
            </ol>
        </nav>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('contents'); ?>
    ...
    <form class="filter-form" action="<?php echo e(Request::fullUrl()); ?>" method="GET">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-3">
                        <div class="d-none d-xl-block" id="desktop_version">
                            <?php echo $__env->make('frontend.default.pages.products.inc.productSidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    ...
                    <div class="col-xl-9">
                        <div class="shop-grid">
                            ...
                            <div
                                ...
                                <p class="mb-0 fw-bold"><?php echo e(localize('Showing')); ?>

                                    <?php echo e($products->firstItem()); ?>-<?php echo e($products->lastItem()); ?> <?php echo e(localize('of')); ?>

                                    <?php echo e($products->total()); ?> <?php echo e(localize('results')); ?></p>
                                <div class="listing-top-right text-end d-inline-flex align-items-center gap-3 flex-wrap">
                                    <div class="number-count-filter d-flex align-items-center gap-3">
                                        <label
                                            class="fw-bold fs-xs text-dark flex-shrink-0"><?php echo e(localize('Show')); ?>:</label>
                                        <input type="number"
                                            <?php if(isset($per_page)): ?>
                                        value="<?php echo e($per_page); ?>"
                                        <?php else: ?>
                                        value="9" 
                                        <?php endif; ?>
                                    ...
                                    <div class="select-filter d-inline-flex align-items-center gap-3">
                                        <label
                                            class="fw-bold fs-xs text-dark flex-shrink-0"><?php echo e(localize('Sort by')); ?>:</label>
                                        <select name="sort_by"
                                            ...
                                            <option value="new"
                                                ...
                                                <?php endif; ?>
                                            <?php endif; ?>>
                                                <?php echo e(localize('Newest First')); ?></option>
                                            <option value="best_selling"
                                                <?php if(isset($sort_by)): ?>
                                            <?php if($sort_by == 'best_selling'): ?>
                                            selected
                                            <?php endif; ?>
                                        <?php endif; ?>>
                                                <?php echo e(localize('Best Selling')); ?></option>
                                        </select>
                                    </div>
                                    <a href="<?php echo e(route('products.index')); ?>?view=grid"
                                        class="grid-btn <?php echo e(request()->view != 'list' ? 'active' : ''); ?> d-none d-xl-flex">
                                    ...
                                    <a href="<?php echo e(route('products.index')); ?>?view=list"
                                        class="grid-btn <?php echo e(request()->view == 'list' ? 'active' : ''); ?> d-none d-xl-flex">
                                        <svg width="21" height="16" viewBox="0 0 21 16" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <div class="row g-4">
                                <?php if(count($products) > 0): ?>
                                    <?php if(request()->has('view') && request()->view == 'list'): ?>
                                ...
                                <?php else: ?>
                                    <div class="col-6 mx-auto">
                                        <img src="<?php echo e(staticAsset('frontend/default/assets/img/empty-cart.svg')); ?>"
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        function loadTemplate(){
            $.ajax({
                url: "<?php echo e(route('products.template')); ?>",
                type: "GET",
                dataType: "html",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.default.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\resources\views/frontend/default/pages/products/index.blade.php ENDPATH**/ ?>