<?php if(count(generateVariationOptions($product->without_variation_combinations)) > 0): ?>
    <?php $__currentLoopData = generateVariationOptions($product->without_variation_combinations); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH G:\laragon\www\resources\views/frontend/default/pages/partials/products/variations.blade.php ENDPATH**/ ?>