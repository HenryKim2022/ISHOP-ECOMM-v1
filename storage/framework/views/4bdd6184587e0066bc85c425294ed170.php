<?php $__env->startSection('title'); ?>
    <?php echo e(localize('Quick Links')); ?> <?php echo e(getSetting('title_separator')); ?> <?php echo e(getSetting('system_title')); ?>
    ...
    <div class="breadcrumb-content">
        ...
        <nav>
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item fw-bold" aria-current="page"><?php echo e(localize('Quick Links')); ?></li>
            </ol>
        </nav>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('frontend.default.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\resources\views/frontend/default/pages/quickLinks/index.blade.php ENDPATH**/ ?>