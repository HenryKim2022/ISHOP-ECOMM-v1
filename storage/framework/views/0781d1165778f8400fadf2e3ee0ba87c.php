...
<?php $__env->startSection('breadcrumb-contents'); ?>
    <div class="breadcrumb-content">
        <h2 class="mb-2 text-center"><?php echo e(localize('Product Details')); ?></h2>
        <nav>
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item active fw-bold" aria-current="page"><?php echo e(localize('Product Details')); ?></li>
            </ol>
        </nav>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('contents'); ?>
    ...
    <section class="product-details-area ptb-120">
        <div class="container">
            <div class="row g-4">
                <?php if($product_page_widgets || getSetting('product_page_banner')): ?>
                    <div class="col-xl-9">
                <?php else: ?>
                    <div class="col-xl-12">
                <?php endif; ?>
                    ...
                    <?php if($product_page_widgets || getSetting('product_page_banner')): ?>
                        <div class="col-xl-3 col-lg-6 col-md-8 d-none d-xl-block">
                            <div class="gshop-sidebar">
                                ...
                                <?php if(getSetting('product_page_banner')): ?>
...
<?php echo $__env->make('frontend.default.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\resources\views/frontend/default/pages/products/show.blade.php ENDPATH**/ ?>