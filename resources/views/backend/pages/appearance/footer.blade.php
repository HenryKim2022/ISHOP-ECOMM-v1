                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="copyright_text" id="copyright_text" class="editor form-control">
                                        {{-- Copyright {!! getSetting('copyright_text') !!} {{ env('APP_ALIAS') }} --}}
                                        {{ getSetting('copyright_text') == null ? "Copyright " . getSetting('copyright_text') . env('APP_ALIAS') : getSetting('copyright_text') }}                        
                                    </textarea>
                                </div>
                            </div>
                        </div>
