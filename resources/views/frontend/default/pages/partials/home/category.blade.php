            ...
            <div class="row justify-content-center g-2">
                ...
                @foreach ($categories as $category)
                    ...
                    <div class="col-xxl-1 cst-img-col-lg-2 col-md-3 col-sm-4">
                        {{-- <div class="gshop-animated-iconbox mh-95 h-95pt py-5 px-4 text-center border rounded-3 position-relative overflow-hidden {{ $loop->even ? 'color-2' : '' }}"> --}}
                         <a href="{{ route('products.index') }}?&category_id={{ $category->id }}">
                            <div class="gshop-animated-iconbox mh-95 h-95pt py-2 px-1 text-center border-0 cst-rounded-32-5 position-relative overflow-hidden {{ $loop->even ? 'color-2' : '' }}">
                                <div
